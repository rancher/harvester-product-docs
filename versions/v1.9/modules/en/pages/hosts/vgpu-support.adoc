= vGPU Support
:description: Enable the nvidia-driver-toolkit add-on to manage vGPU devices, check GPU support for SR-IOV, configure profiles through the UI, and verify device scanning
:revdate: 2026-06-03
