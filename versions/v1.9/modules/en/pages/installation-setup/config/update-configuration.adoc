...
:description: Update the configuration after installation by modifying runtime values and configuration files to ensure changes persist across reboots, as the SUSE system does not save changes automatically
:revdate: 2026-06-04
