...
This capability is provided by the Elemental Toolkit's https://rancher.github.io/elemental-toolkit/docs/customizing/runtime_persistent_changes/[`after-install-chroot` and `after-upgrade chroot` stages]. You will typically define identical command sets in both stages.
