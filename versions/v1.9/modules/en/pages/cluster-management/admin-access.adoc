...
:description: Recover passwords for UI and Console User Accounts by accessing management nodes via SSH or modifying configuration files with kubeconfig files
:revdate: 2026-07-17
