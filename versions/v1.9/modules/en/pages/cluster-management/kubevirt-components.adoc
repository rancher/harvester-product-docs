...
When patching `ManagedChart`, include all existing elements under https://github.com/harvester/harvester/blob/ba08b5d8201e0292628a3f80c93fe1f19456e084/deploy/charts/harvester/values.yaml#L106-L123[`customizeComponents.patches`]. This ensures that default configurations are preserved rather than overwritten.
