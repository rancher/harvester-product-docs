= KubeVirt Components
:description: Learn how to adjust resource limits for KubeVirt components to ensure stable node resource allocation and prevent pod crashes during scaling
:revdate: 2026-08-07
