...
:description: Upgrade from v1.6.x to v1.7.x requires checking compatibility, updating the Harvester UI Extension, and migrating network configurations from wicked
:revdate: 2026-06-10
