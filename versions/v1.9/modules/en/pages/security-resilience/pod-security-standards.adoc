...
:description: Apply Kubernetes Pod Security Standards cluster-wide to enforce policies that restrict workload execution and prevent privilege escalation
:revdate: 2026-06-10
