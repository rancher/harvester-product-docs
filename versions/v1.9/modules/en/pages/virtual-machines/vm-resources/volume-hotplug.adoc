= Volume Hotplug
:description: Add a hot-plug volume to a running virtual machine by going to the Virtual Machines page, selecting the virtual machine, choosing Add Volume
:revdate: 2025-05-09
