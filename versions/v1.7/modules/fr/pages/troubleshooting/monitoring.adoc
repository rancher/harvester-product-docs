...
. Activez le produit complémentaire `rancher-monitoring` xref:../add-ons/add-ons.adoc[add-on], vous observerez{nbsp}:
...
Ce processus prend généralement peu de temps à compléter, mais peut être perturbé lorsque les éléments suivants se produisent{nbsp}:
