...
* Starting with v0.1.25, if you install the Harvester CSI Driver without the Harvester Cloud Provider enabled, you must ensure that <<Volume snapshots, volume snapshot resources>> are properly installed. Otherwise, the chart installation will fail.
