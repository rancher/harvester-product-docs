...
|===
| Harvester CSI Driver Version | {harvester-product-name} Version | Storage Tiering | RWX Volumes | Online Resizing | Third-Party Storage | Snapshots and Backups | Volume Snapshots
