= Terraform Provider
:description: Configure the Terraform Provider by adding it to your configuration, initializing with terraform init, and defining timeout blocks for resource
:revdate: 2026-05-06
