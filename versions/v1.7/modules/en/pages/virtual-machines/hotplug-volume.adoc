= Hot-Plug Volumes
:description: Add hot-plug volumes to a running virtual machine by navigating to the Virtual Machines page, selecting the target virtual machine, entering a name, choosing
