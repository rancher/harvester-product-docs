...
:description: Deploy a high-availability cluster with three or more nodes by following steps to configure cluster settings, install nodes, and join them to the cluster
