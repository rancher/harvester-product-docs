...
+
If you require customizations, see <<#_customizing_the_version>>.
+
...
----
+
Assume the file is hosted at `+http://10.10.0.1/version.yaml+`. If you require customizations, see <<#_customizing_the_version>>.
