...
:description: Upgrade from v1.7.x to v1.7.y by checking the Dashboard for the Upgrade button, preparing air-gapped environments if needed, and updating the Harvester UI
:revdate: 2026-07-07
