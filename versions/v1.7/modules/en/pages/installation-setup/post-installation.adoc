...
:description: Perform post-installation tasks to enhance the security and performance of the SUSE Virtualization cluster by disabling SSH password authentication
