= Management Address
:description: Find the management address to access the SUSE Virtualization API/UI and let nodes join the cluster
...
[#_identifying_node_vip_assigned]
