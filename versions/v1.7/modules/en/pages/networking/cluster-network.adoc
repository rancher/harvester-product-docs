...
Starting with v1.6.0, only the xref:installation-setup/config/configuration-file.adoc#_install_management_interface[primary VLAN ID] provided during installation is automatically added to the `mgmt-br` bridge and the `mgmt-bo` interface. You can <<#_add_secondary_vlan_interfaces,add secondary VLAN interfaces>> after installation is completed.
...
[#_add_secondary_vlan_interfaces]
...
For more information, see <<#_change_mtu_no_attached_storage_network>>.
...
[#_change_mtu_no_attached_storage_network]
