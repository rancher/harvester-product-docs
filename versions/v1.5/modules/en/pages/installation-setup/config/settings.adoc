= Settings
:description: Configure advanced settings using the UI or kubectl to modify the settings.harvesterhci.io custom resource, including additional CA certificates
:revdate: 2026-06-05
