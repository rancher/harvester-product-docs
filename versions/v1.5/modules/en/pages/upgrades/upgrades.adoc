= Upgrades
:description: Find supported upgrade paths and procedures for SUSE Virtualization, including Rancher upgrades and virtual machine migration during upgrades
:revdate: 2026-06-05
...
| v1.4.2 and v1.4.3
| xref:upgrades/v1-4-2-to-v1-5-1.adoc[v1.5.1]

| v1.4.2 and v1.4.3
| xref:upgrades/v1-4-2-to-v1-5-0.adoc[v1.5.0]
|===
