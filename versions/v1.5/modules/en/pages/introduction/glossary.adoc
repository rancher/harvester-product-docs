= Glossary
:description: Define key terms related to SUSE Virtualization and Kubernetes clusters, including cluster networks, guest clusters, and hypervisor components, to help users
:revdate: 2026-01-27
