...
:description: Create an RKE1 Kubernetes cluster using the Harvester Node Driver to provision nodes using cloud credentials and configure cluster settings
:revdate: 2025-06-09
...
RKE1 and RKE2 have several slight behavioral differences. For more information, see https://documentation.suse.com/cloudnative/rancher-manager/v2.11/en/cluster-deployment/rke1-vs-rke2.html[differences between RKE1 and RKE2].
