= Harvester Seeder
:description: Use the harvester-seeder add-on to perform out-of-band operations and discover hardware events on SUSE Virtualization hosts using IPMI and Redfish
:revdate: 2025-12-31
