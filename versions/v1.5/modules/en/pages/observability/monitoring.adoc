= Monitoring
:description: Enable or disable the Rancher Monitoring add-on and view cluster metrics, VM metrics, and live migration status using the SUSE Virtualization UI or Grafana
:revdate: 2025-06-16
