...
:description: Clone a virtual machine with or without volume data, inherit its basic configuration, customize the clone's name and run strategy, and optionally preserve EFI
:revdate: 2024-12-23
