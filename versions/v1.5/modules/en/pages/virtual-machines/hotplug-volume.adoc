= Hot-Plug Volumes
:description: Add a hot-plug volume to a running virtual machine by selecting the virtual machine on the Virtual Machines page, entering the volume name, and choosing the volume
:revdate: 2024-12-23
