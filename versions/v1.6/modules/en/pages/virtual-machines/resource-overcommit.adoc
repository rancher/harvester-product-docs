= Resource Overcommit
:description: Configure resource overcommit ratios for CPU, memory, and storage in SUSE Virtualization to increase virtual machine count while managing performance impact
:revdate: 2025-05-09
