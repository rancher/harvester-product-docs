...
:description: Create custom SUSE Virtual Machine Images with openSUSE Build Service templates or the Kiwi command-line tool to add packages and build images
:revdate: 2025-05-09
