= CPU Pinning
:description: Configure CPU pinning in SUSE Virtualization by enabling the CPU Manager on nodes then setting dedicatedCpuPlacement to true when creating a virtual machine
:revdate: 2025-10-20
