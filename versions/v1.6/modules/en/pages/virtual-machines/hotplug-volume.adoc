= Hot-Plug Volumes
:description: Add hot-plug volumes to a running virtual machine by accessing the Virtual Machines page, selecting the target machine, entering the volume name, and choosing
:revdate: 2025-05-09
