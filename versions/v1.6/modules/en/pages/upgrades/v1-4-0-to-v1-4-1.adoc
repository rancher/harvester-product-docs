...
To import {harvester-product-name} v1.4.1 clusters on {rancher-short-name} v2.10.1, you must use **v1.0.3** of the {rancher-short-name} UI extension for {harvester-product-name}.
