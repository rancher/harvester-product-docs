= Upgrade from v1.5.0 or v1.5.1 to v1.5.2
:description: Upgrade SUSE Virtualization from v1.5.0 or v1.5.1 to v1.5.2 and learn about known issues and Harvester UI Extension updates
:revdate: 2025-11-11
