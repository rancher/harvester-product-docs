...
:description: Upgrade from v1.5.x to v1.6.x using the Upgrade button on the Dashboard when available, as SUSE Virtualization allows one minor version upgrade
:revdate: 2026-06-11
