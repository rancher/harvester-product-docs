...
:description: Use the Harvester CSI Driver to connect SUSE Virtualization clusters and hot-plug volumes for guest Kubernetes nodes
:revdate: 2026-07-02
...
For more information, see the https://github.com/harvester/harvester/blob/v1.6/deploy/charts/harvester/templates/rbac.yaml[RBAC configuration] in the GitHub repository.
