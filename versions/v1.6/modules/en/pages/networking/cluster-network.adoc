...
In this scenario, the xref:./storage-network.adoc#_harvester_storage_network_setting[storage network] is neither enabled nor attached to the target cluster network.
...
In this scenario, the xref:./storage-network.adoc#_harvester_storage_network_setting[storage network] is enabled and attached to the target cluster network.
