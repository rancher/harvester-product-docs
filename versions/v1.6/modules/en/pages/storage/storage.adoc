= Storage
:description: Create and manage block storage volumes in SUSE Virtualization using virtual machine images or StorageClasses, ensuring volume size matches image size
:revdate: 2026-05-12
