= Create a Volume
:description: Create a volume by setting a name and description, choosing a source type, selecting a storage class, and configuring its size, and being aware of oversized
:revdate: 2025-12-05
