= Logging Issues
:description: Troubleshoot issues when enabling the rancher-logging add-on in SUSE Virtualization by checking the Logging Operator installation and upgrade processes
:revdate: 2026-01-20
