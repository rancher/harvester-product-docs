= Cluster Issues
:description: Solve cluster issues by configuring HTTP proxy settings during or after installation, addressing node availability problems, and generating support bundles
:revdate: 2025-06-20
