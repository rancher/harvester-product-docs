= USB Installation
:description: Create a bootable USB flash drive using Rufus, balenaEtcher, or the dd command on Windows, macOS, or Linux by selecting an ISO image and a target device
:revdate: 2026-01-08
