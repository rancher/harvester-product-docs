...
This issue affects Rancher v2.10.x, which uses v1.0.2, v1.0.3, and v1.0.4 of the xref:../integrations/rancher/harvester-ui-extension.adoc#_support_matrix[Harvester UI Extension]. All other {harvester-product-name} UI versions are not affected. The issue will be fixed in Harvester UI Extension v1.0.5 and v1.5.0.
