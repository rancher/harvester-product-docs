...
. Check the upgrade repository volume in the Longhorn GUI.
 .. xref:../troubleshooting/harvester-cluster.adoc#_access_embedded_rancher_and_longhorn_dashboards[Go to Longhorn GUI].
...
Visit xref:../troubleshooting/harvester-cluster.adoc#_access_embedded_rancher_and_longhorn_dashboards["Access Embedded Longhorn"] to see how to access the embedded Longhorn GUI.
