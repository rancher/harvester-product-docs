...
* Make sure your hardware meets the *preferred* lxref:../install/requirements.adoc#_hardware_requirements[hardware requirements]. This is due to there will be intermediate resources consumed by an upgrade.
