...
. Log in to a Harvester node and become root. See xref:../../troubleshooting/operating-system.adoc#_how_to_log_in_to_a_harvester_node[how to log into a Harvester node] for more details.
...
For more information about NTP settings in Harvester v1.2.0 and later versions, see the xref:../../hosts/hosts.adoc#_ntp_configuration[NTP servers].

== Password of user `rancher`

=== Runtime change

. Log in to a Harvester node as user `rancher`. See xref:../../troubleshooting/operating-system.adoc#_how_to_log_in_to_a_harvester_node[how to log into a Harvester node] for more details.
