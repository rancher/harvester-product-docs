...
* Change the xref:../install/harvester-configuration.adoc#_install_harvester_storage_class_replica_count[replica count] of `harvester-longhorn` to *1* using a xref:../install/harvester-configuration.adoc[Harvester configuration] file.
