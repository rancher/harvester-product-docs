...
. On the xref:../troubleshooting/harvester-cluster.adoc#_access_embedded_rancher_and_longhorn_dashboards[embedded Longhorn dashboard], verify that the status of all Longhorn volumes is __Healthy__.
...
If you observe any abnormalities, generate a xref:../troubleshooting/harvester-cluster.adoc#_generate_a_support_bundle[support bundle] for troubleshooting purposes.
