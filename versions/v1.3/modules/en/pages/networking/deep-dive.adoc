...
The diagram contains xref:networking/cluster-network.adoc#_built_in_cluster_network[the built-in cluster network mgmt] and a xref:networking/cluster-network.adoc#_custom_cluster_network[custom cluster network]called `oob`.
