...
Users can also enable/disable the `rancher-logging` addon in their Harvester installation by customizing the xref:../installation-setup/config/harvester-configuration.adoc#_installaddons[harvester-configuration] file.
