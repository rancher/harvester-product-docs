...
The diagram contains xref:./clusternetwork.adoc#_built_in_cluster_network[the built-in cluster network mgmt] and a xref:./clusternetwork.adoc#_custom_cluster_network[custom cluster network] called `oob`.
