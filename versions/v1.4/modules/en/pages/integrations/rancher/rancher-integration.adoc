...
Users can import and manage multiple Harvester clusters using the Rancher xref:integrations/rancher/virtualization-management.adoc[Virtualization Management] feature. Leveraging the Rancher's https://ranchermanager.docs.rancher.com/v2.7/pages-for-subheaders/authentication-config[authentication] feature and https://ranchermanager.docs.rancher.com/v2.7/pages-for-subheaders/manage-role-based-access-control-rbac[RBAC control] for xref:integrations/rancher/virtualization-management.adoc#_multi_tenancy[multi-tenancy] support.
...
For in-depth insights, please refer to the xref:integrations/rancher/virtualization-management.adoc[virtualization management] page.
