...
:description: Assign cluster and project roles in Rancher using Helm chart integration to control access to SUSE Virtualization resources, ensuring users have appropriate
:revdate: 2026-06-08
