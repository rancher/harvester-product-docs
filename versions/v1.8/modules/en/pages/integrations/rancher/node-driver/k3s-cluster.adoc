...
:description: Create a K3s Kubernetes cluster using the Harvester node driver in Rancher by entering cloud credentials, cluster name, namespace, image, network name
:revdate: 2026-06-12
