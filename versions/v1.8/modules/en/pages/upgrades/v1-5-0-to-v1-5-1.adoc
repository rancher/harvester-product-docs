...
:description: Upgrade SUSE Virtualization from v1.5.0 to v1.5.1 using the Dashboard Upgrade button and update the Harvester UI Extension on Rancher v2.11
:revdate: 2025-07-07
