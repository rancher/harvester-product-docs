...
:description: Upgrade from v1.6.x to v1.6.y by following steps to update the Harvester UI Extension and address issues like stuck upgrades or failed migrations
:revdate: 2026-06-04
