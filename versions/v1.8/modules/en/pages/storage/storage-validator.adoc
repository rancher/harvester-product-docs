= Storage Validator
:description: The storage-validator utility tests the compatibility of storage solutions with SUSE Virtualization by verifying volume creation, snapshot operations, virtual
:revdate: 2026-01-21
