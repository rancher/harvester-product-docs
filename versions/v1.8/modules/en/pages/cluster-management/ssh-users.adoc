...
:description: Create users with SSH access to Harvester nodes by using cloud-init.yaml for public key or password authentication, adding them to the admin group
:revdate: 2026-07-17
