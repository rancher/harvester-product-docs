...
:description: Enable the pcidevices-controller add-on to manage PCI devices by creating PCIDeviceClaim resources or using the UI to pass devices through the hypervisor
:revdate: 2026-05-06
