...
:description: Configure host network settings and select an underlay for SUSE Virtualization by managing VLAN IP assignments and Kube-OVN overlay traffic
:revdate: 2026-07-16
